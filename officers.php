...
<?php
      include('./conn.php');
      $getDean = mysqli_query($db, "SELECT * FROM officers WHERE position='Dean'");
      $getAD = mysqli_query($db, "SELECT * FROM officers WHERE position='Associate Dean'");
      $getAdviser = mysqli_query($db, "SELECT * FROM officers WHERE position='Adviser'");
      ...
      $getRepresentative = mysqli_query($db, "SELECT * FROM officers WHERE position='Representative'");
...
<head>
  ...
  <title>CSC Organizational Chart</title>
...
<body>
  ...
  <div class="relative bg-white overflow-hidden">
        ...
        <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
          <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-1 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <a href="#">
              ...
              <a href="officers.php" class="bg-gray-200 px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">Organizational Chart</a>
              <a href="about.php" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">About</a>
              <a href="events-page.php" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">Events</a>
              <?php
               if (isset($_SESSION['id']) && (isset($_SESSION['username'])))  {
                 echo ' 
                 <button class="px-1 py-1 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" type="button" onclick="openDropdown(event,`dropdown-example-1`)">
             ...
             <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1" style="min-width: 12rem" id="dropdown-example-1">
              ...
              ?>
              <a class="hidden px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200" ></a>
    ...
    <div class="p-8">
      <h1 class="text-center text-3xl font-extrabold text-gray-900">CSC <span  class="text-yellow-500">Organizational Chart</span ></h1>
    </div>
    <div class="flex justify-center ">
        <div class="text-center ">
          <?php while ($row = mysqli_fetch_array($getDean)) { ?>
            <div class=" flex justify-center">
          ...
          <?php } ?>
           ...
           <div class="flex flex-col md:flex-row items-center gap-1 md:gap-20">
                <?php while ($row = mysqli_fetch_array($getAD)) { ?>
                 <div class="bg-gray-300 p-4 m-4" style="width: 280px">
                  ...
                  <?php } ?>
                 <?php while ($row = mysqli_fetch_array($getAdviser)) { ?>
                <div class="bg-gray-300 p-4 m-4" style="width: 280px">
                    <img src="<?php echo './admin/officers/upload/' . $row['picture'] ?>" class="w-full" alt="" >
                    <p class="bg-yellow-500 uppercase mt-2"><?php echo $row['name'] ?></p>
        ...
        <div class="mx-auto" style="max-width: 1000px">
            <div class="flex flex-wrap justify-center">
                <?php while ($row = mysqli_fetch_array($getRepresentative)) { ?>
