        ...
        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            ...
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-sm sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              It serves as the mother organization of all accredited organizations by facilitating several activities of students in the said institution the whole academic year. Programs and projects are also organized by the CSC for the total development of the students like Literary, Visual Arts, Musical and Dance Competitions and Leadership Trainings. <br> You can also access the oficial facebook page of the BUPC CSC by tapping the link below.
            </p> <br>

            <a href="https://web.facebook.com/bupc.csc.one" class="py-2 px-5 bg-yellow-400 rounded text-white hover:bg-yellow-300 transition-all">Official FB Page</a>
          </div>
        </main>
      </div>
    </div>
