                ...
                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" value="<?php echo $row['fbpost']?>"  placeholder="paste the full link here..." autocomplete="off" name="fbpost" class="bg-gray-100 focus:outline-none border-none focus:bg-gray-200 rounded py-2 px-2 text-gray-500 w-full">
                        </div>
