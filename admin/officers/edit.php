                        ...
                        <div class="flex justify-center">
                            <div class="space-y-4 relative">
                                <div class="rounded-full overflow-hidden" style="width: 140px; height: 140px;">
                                    ...
                                    <?php else : ?>
                                        <img class="h-10 w-10 rounded-full" src="<?php echo '../officers/upload/' . $row['picture'] ?>" alt="" style="object-fit: cover; width: 100%; height: 100%" name="picture" onClick="triggerClick()" id="profileDisplay">
                                    <?php endif; ?>
                                </div>
