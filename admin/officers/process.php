<?php
    ...
    if (isset($_POST['save'])) {
       ...
       if (isset($_POST['add'])) {
        ...
        $query = "INSERT INTO officers (name, position, course, yearLevel, buEmail, fb, picture, username, password) VALUES ('$name', '$position', '$course', '$yearLevel', '$fb', '$picture', '$username', '$password')";
        mysqli_query($db, $query);
